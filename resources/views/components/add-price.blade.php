...
<div class="max-w-2xl mb-4  leading-none tracking-tight dark:text-black">
@if ($errors->any())
...
@endif
    <form class="max-w-sm mx-auto" method="POST" action="{{ route('price.submit') }}">
...
{{--        <div class="mb-5">
        ...
        <div class="flex items-start mb-5">
            ...
            <label for="remember" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Add another</label>
        </div>
